...
\makeatother
\begin{document}  
	\begin{titlepage}\heiti \begin{center} % Upper part of the page 
			\includegraphics[width=0.5\textwidth]{pic/logo.png} \\
			[0.3cm]\ \\
          {\zihao{-2}\fontspec{FandolHei}2014 级毕业设计(论文)} \\
			[0.5cm]\ \\
            [0.4cm] {\zihao{1} 基于优化算法的航班选择系统的设计与开发}
      \\[4.3cm]
			\begin{minipage}[t]{0.7\textwidth} 
				\centering
                \zihao{-2} {年\quad\quad 级:} 
				\uline{\makebox[0.7\textwidth]{\fontspec{FandolHei}2014级}}\par
			\end{minipage}
			\\[0.6cm]
			\begin{minipage}[t]{0.7\textwidth}
				\centering
                \zihao{-2} {学\quad\quad 号:} 
                \uline{\makebox[0.7\textwidth]{\fontspec{FandolHei}2014271055}}\par
			\end{minipage}
			\\[0.6cm]
			\begin{minipage}[t]{0.7\textwidth}
				\centering
                \zihao{-2} {姓\quad\quad 名:} 
				\uline{\makebox[0.7\textwidth]{李恩宾}}\par
			\end{minipage}
			\\[0.6cm]
			\begin{minipage}[t]{0.7\textwidth}
				\centering
                \zihao{-2} {专\quad\quad 业:} 
